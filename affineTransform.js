...
function drawRectangleArray(arrayRectangle,color){
    ctx.beginPath();
    ctx.moveTo(arrayRectangle[0][0],arrayRectangle[0][1]);
    for (let i = 1; i < arrayRectangle.length; i++) {
        ctx.lineTo(arrayRectangle[i][0],arrayRectangle[i][1]);
    }
    ctx.closePath();
...
drawRectangleArray(rectangleArray,'blue');